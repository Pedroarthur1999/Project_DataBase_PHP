...
// Check connection
  ...
  $sql = "INSERT INTO endereco (nome, idade, endereco, numero) VALUES ('$nome', '$idade','$endereco','$numero')";
  if ($conn->query($sql) === TRUE) {
    echo "<script>alert('Usuario cadastrado com sucesso');location.href=\"cadastrar_endereco.php\";</script>";
